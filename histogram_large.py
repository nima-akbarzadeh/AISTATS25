...
# Load the Excel file
file_path = 'Res_m3.xlsx'  # Replace with your Excel file path
...
filtered_df = df[df['Key'].str.contains(r'^nt5_nc5_ns5_', regex=True)]
...
# Save the plot
output_path = 'histogram_plot_large.png'
